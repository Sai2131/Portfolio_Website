...
export function AboutMe() {
  ...
  return ( 
    <div className="text-center fs-7 w-80 mt-5 text-light border border border-5 border-dark rounded blur">
        <p className='m-3'>
          I'm a senior at UCSC from Santa Clara, CA. I'm passionate about computer science, with particular interests in 
